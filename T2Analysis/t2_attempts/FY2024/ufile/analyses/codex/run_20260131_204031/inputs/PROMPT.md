...
2) You **MAY** run commands and scripts, but **all write outputs must go ONLY** into a dedicated run directory under:
   - `/home/clarencehub/t2-final-fy2024-fy2025/T2Analysis/t2_attempts/FY2024/ufile/analyses/codex/run_20260131_204031`
...
- `/home/clarencehub/t2-final-fy2024-fy2025/T2Analysis/t2_attempts/FY2024/ufile/exports/attempt_001/ufile_return.pdf`

## UFile “Messages” / warnings (required)
- `/home/clarencehub/t2-final-fy2024-fy2025/T2Analysis/t2_attempts/FY2024/ufile/exports/attempt_001/messages.txt`

Copy the messages file you relied on into `RUN_DIR/inputs/`.

## Parsed evidence bundle (preferred analysis input)
- `/home/clarencehub/t2-final-fy2024-fy2025/T2Analysis/t2_attempts/FY2024/ufile/parses/attempt_001`
...
- `UfileToFill/ufile_packet/years/FY2024/UFILet2_FILL_GUIDE.html` (if present)
...
- `output/gifi_schedule_100_FY2024.csv`
- `output/gifi_schedule_125_FY2024.csv`
- `output/gifi_retained_earnings_FY2024.csv`
- `output/schedule_1_FY2024.csv`
- `output/schedule_8_FY2024.csv` (if CCA exists)

---

# Objective

Determine (with explicit arithmetic) why the `FY2024` UFile attempt produced diagnostics, warnings, and/or non-balancing schedules, and decide whether root cause is:
...
Read `/home/clarencehub/t2-final-fy2024-fy2025/T2Analysis/t2_attempts/FY2024/ufile/parses/attempt_001/verification_report.md`.
...
- Attempt value
- Project expected value (from `UfileToFill/ufile_packet/years/FY2024/packet.json` and/or `output/*.csv`)
- Delta
...
1) Locate packaging-related TB accounts and their mapped GIFI lines for `FY2024`:
